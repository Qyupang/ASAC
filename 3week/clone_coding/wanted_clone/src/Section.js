      ...
      <main>
        <section className="main-banner">
          <div className="banners">
            <div className="banner">
              ...
              <div className="banner-descript">
                <div className="banner-descript__text">
                  <span className="banner-descript__title">
                    기업이 원하는 프론트엔드 개발자 되기
                  </span>
                  <span className="banner-descript__descript">
                    프리온보딩 프론트엔드 코스
                  </span>
            ...
            <div className="banner">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fbanners%2F1853%2F2464b111.jpg&w=1060&q=100"
                alt=""
                width="100%"
                height="300px"
                className="banner-image"
        ...
        <section className="career-insight">
          ...
          <div className="career-insight__buttons">
            <div className="career-insight__button">
              <span>리더십</span>
            </div>
            <div className="career-insight__button">
              <span>라이프스타일</span>
          ...
          <div className="career-insight__contents">
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=http%3A%2F%2Ft1.daumcdn.net%2Fbrunch%2Fservice%2Fuser%2FcK73%2Fimage%2FjpGay3WOoMl_URviAArdk0P6Urk.JPG&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              <span className="career-insight__content-title">
                스타트업과 횡령
              </span>
              <p className="career-insight__content-main">
                내가 100% 지분을 소유하고 있고, 내가 대표이사로 있는 회사, 내
                자식처럼, 내 몸처럼 소중합니...
              </p>
              <div className="career-insight__content-info">
                ...
                <span className="content-info__author">법무법인 미션</span>
              </div>
            </div>
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fwanted.video.kr.kollus.com%2Fkr%2Fsnapshot%2Fwanted%2F20220204%2F6%2F64155495.jpg&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              <span className="career-insight__content-title">
                경영기획&전략기획 지침서 07 - 관리회계
              </span>
              <p className="career-insight__content-main">
                실질분석, 손익분석 등 회사마다 쓰는 용어의 차이에 대해
                알아봅니다. 용어에 대해 알아본 뒤 공통...
              </p>
              <div className="career-insight__content-info">
                <div className="content-info__logo">
                  <img
                ...
                <span className="content-info__author">
                  {' '}
                  조로, 메이, 쌤, 앨리스{' '}
                </span>
              </div>
            ...
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fi.ytimg.com%2Fvi%2FUp5kLCTC5PQ%2Fhqdefault.jpg%3Fsqp%3D-oaymwEcCPYBEIoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg%3D%3D%26rs%3DAOn4CLAczGsjeN_G4SHTEXgLQjPpC0RMpg&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              <span className="career-insight__content-title">
                토스 | 스타트업 서바이벌 FOUND - EP 5.UNLOCK [도전을 선
                선보이다]
              </span>
              <div className="career-insight__content-info">
                <div className="content-info__logo">
                ...
                <span className="content-info__author">토스</span>
              </div>
            </div>
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fwanted.video.kr.kollus.com%2Fkr%2Fsnapshot%2Fwanted%2F20220204%2F6%2F33372120.jpg&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              <span className="career-insight__content-title">
                경영기획&전략이획 지침서 06 - 예산관리
              </span>
              <p className="career-insight__content-main">
            ...
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=http%3A%2F%2Ft1.daumcdn.net%2Fbrunch%2Fservice%2Fuser%2FVZ4%2Fimage%2FlbRNcRrfnvVBOI34jRXaFeaZCcw.png&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              ...
              <div className="career-insight__content-info">
                ...
                <span className="content-info__author">Brown Jeon</span>
              </div>
            </div>
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fwanted.video.kr.kollus.com%2Fkr%2Fsnapshot%2Fwanted%2F20220204%2F6%2F89798825.jpg&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              <span className="career-insight__content-title">
                경영기획&전략기획 지침서 03 - 기획의 꽃 경영게획 수립 2편
              </span>
              <p className="career-insight__content-main">
            ...
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=http%3A%2F%2Ft1.daumcdn.net%2Fbrunch%2Fservice%2Fuser%2F1J9E%2Fimage%2F8aGdQPrEamkfcfEHQiOsIHcyItg.png&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              ...
              <div className="career-insight__content-info">
                ...
                <span className="content-info__author"> 기묘한 </span>
              </div>
            </div>
            <div className="career-insight__content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fwanted.video.kr.kollus.com%2Fkr%2Fsnapshot%2Fwanted%2F20220204%2F6%2F79566772.jpg&w=500&q=75"
                alt=""
                width="250"
                height="170"
              />
              <span className="career-insight__content-title">
                경영기획&전략기획 지침서 01 - 경영기획/경영관리 정의 및 업무개괄
              </span>
              <p className="career-insight__content-main">
        ...
        <section className="article">
          ...
          <div className="article-contents">
            <div className="article-content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fevents%2F2427%2F9d71c6cc.jpg&w=800&q=75"
                alt=""
              />
              <span className="article-content__title">
                애써 모셔온 시니어, 우리 조직엔 안 맞는 사람?
              </span>
              <span className="article-content__tag">
                #HR #조직문화 #리더십
              </span>
            </div>
            <div className="article-content">
            ...
            <div className="article-content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fevents%2F2422%2Ffeb067d4.jpg&w=800&q=75"
                alt=""
                className="article-image"
              />
              <span className="article-content__title">
                기업의 성공을 리드하는 번개장터 마케터의 데이터
              </span>
              <span className="article-content__tag">
                #마케팅·광고 #브랜딩 #데이터
              </span>
          ...
          <div className="vod-contents">
            <div className="vod-content">
              <img
                ...
                className="vod-image"
              />
              <span className="runtime">1:29:15</span>
              <span className="vod-content__maker">
                인터비즈 팀장클럽 김진영
              </span>
              <span className="vod-content__title">팀장으로 산다는 건</span>
              <span className="vod-content__tag">
                팀장으로 산다는 건: Live Talk #30
              </span>
            </div>
            <div className="vod-content">
              <img
                src="https://image.wanted.co.kr/optimize?src=http%3A%2F%2Fwanted.video.kr.kollus.com%2Fkr%2Fsnapshot%2Fwanted%2F20211111%2F10%2F24788089.jpg&w=800&q=75"
                alt=""
                className="vod-image"
              />
              <span className="runtime">58:29</span>
              <span className="vod-content__maker">
                퍼플밴드 권순관, 드림어스 제정민
              </span>
              <span className="vod-content__title">
                신입 개발자의 취업 성공기
              </span>
              <span className="vod-content__tag">
            ...
            <div className="vod-content">
              <img
                ...
                className="vod-image"
              />
              <span className="runtime">39:34</span>
              <span className="vod-content__maker">애프터모멘트 박창선</span>
              <span className="vod-content__title">
                터지는 콘텐츠는 이렇게 만듭니다 Part3 : 위트와 무리수레벨
                조절하기 - 박...
              </span>
              <span className="vod-content__tag">
                터지는 콘텐츠는 이렇게 만듭니다 : Wanted...
              </span>
            </div>
            <div className="vod-content">
              <img
                ...
                className="vod-image"
              />
              <span className="runtime">1:34:40</span>
              <span className="vod-content__maker">
                노무법인 예담HR컨설팅 장내석
              </span>
              <span className="vod-content__title">회사를 구하는 인사</span>
              <span className="vod-content__tag">
                회사를 구하는 인사: Live Talk #27
              </span>
            </div>
          </div>
        </section>
          ...
          <div className="event-contents">
            <div className="event-content">
              <img
                ...
                alt=""
                className="event-content__image"
              />
              <div className="event-content__types">
                <span className="event-content__type">온라인</span>
                <span className="event-content__type1">VOD</span>
              </div>
              <span className="event-content__title">
                [무료] 이력서, 포트폴리오, 면접을 부탁해 by 원티드
              </span>
              <span className="event-content__date">2022.10.31(월)</span>
            </div>
            <div className="event-content">
              <img
                src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fevents%2F2406%2F6aae1a5c.jpg&w=1200&q=100"
                alt=""
                className="event-content__image"
              />
              <div className="event-content__types">
          ...
          <nav className="nav-carear-info">
            ...
            <div className="nav-career-menu">
              <a
                ...
                className="nav-career__box"
              >
                <i className="fa-solid fa-magnifying-glass"></i>
                <span className="nav-career__text">채용공고 {`>`}</span>
              </a>
              <a
              ...
              >
                ...
                <span className="nav-career__text">내 프로필 {`>`}</span>
              </a>
              <a
              ...
              >
                ...
                <span className="nav-career__text">매치업 {`>`}</span>
              </a>
              <a
              ...
              >
                ...
                <span className="nav-career__text">직군별 연봉 {`>`}</span>
              </a>
            </div>
          </nav>
        </section>
