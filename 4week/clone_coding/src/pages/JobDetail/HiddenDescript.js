...
const HiddenDescript = ({ pageId }) => {
  ...
  return (
    <div className="job-detail__warning-bottom detail-hidden">
      <p>
        본 채용 정보는 <strong className="strong">{company.companyName}</strong>
        에서 제공한 자료를 바탕으로 원티드랩에서 표현을 수정하고 이의 배열 및 구
        <br />
        성을 편집하여 완성한 원티드랩의 저작자산이자 영업자산입니다. 본 정보 및
        데이터베이스의 일부 내<br />
        지는 전부에 대하여 원티드랩의 동의 없이 무단전재 또는 재배포, 재가공 및
        크롤링할 수 없으며, 게재
